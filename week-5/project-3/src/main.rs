//Rust program that displays menu for food items available

use std::io;

fn main() {
    println!("Welcome to the restaurant. \nWe have the following meals available");
    println!("\nA portion of poundo yam and edikaiko soup is N3200");
    ...
    println!("Enter portion of poundo yam and edikainko you want");
    let mut want1 = String::new();
      ...
      let input1:f64 = want1.trim().parse().expect("Not a valid number");
       ...
       println!("Enter portion of fried rice and chicken you want");
    let mut want2 = String::new();
      ...
      let input2:f64 = want2.trim().parse().expect("Not a valid number");
       ...
       println!("Enter portion of amala and ewedu soup you want");
    let mut want3 = String::new();
      ...
      let input3:f64 = want3.trim().parse().expect("Not a valid number");
       ...
       println!("Enter portion of eba and egusi soup you want");
    let mut want4 = String::new();
      ...
      let input4:f64 = want4.trim().parse().expect("Not a valid number");
       ...
       println!("Enter portion of white rice and stew you want");
